  ...
  <header>
    <div class="hbar">
      <a href="index.html" class="brand">
        <img class="brand-mark-full" src="assets/wil-main-logo.png?v=202607311615" alt="DearMonday Workation Insight Lab">
      </a>
...
function mountFooter(){
  ...
  <footer>
    <div class="container">
      <div class="f-row">
        <div class="f-brand">
          <img class="f-brand-full" src="assets/wil-footer-logo.png?v=202607311615" alt="DearMonday Workation Insight Lab">
        </div>
        <div class="f-act">
