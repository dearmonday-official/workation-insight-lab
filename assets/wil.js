...
const I18N = {
  en: {
    ...
    'dash.corp.cmp2Title': 'Average Office+Room Booking Cost Comparison', 'dash.corp.cmp2Unit': 'Per Person, Per Night',
  ...
  ja: {
    ...
    'dash.corp.cmp2Title': '平均オフィス+客室予約費用比較', 'dash.corp.cmp2Unit': '1人・1泊当たり',
  ...
  zh: {
    ...
    'dash.corp.cmp2Title': '平均办公室+客房预订费用对比', 'dash.corp.cmp2Unit': '每人每晚',
